...
export const EducationContent = [
  {
    instituteName: "Nanyang Technological University, Singapore",
    qualificationName:
  ...
  {
    instituteName: "Zagreb School of Economics and Management (ZSEM)",
  ...
  {
    instituteName: "Raffles Institution Junior College",
